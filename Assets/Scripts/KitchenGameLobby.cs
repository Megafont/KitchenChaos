...
public class KitchenGameLobby : MonoBehaviour
{
    ...
    private async void InitializeUnityAuthentication()
    {
        ...
        if (UnityServices.State != ServicesInitializationState.Initialized)
        {
            ...
            // NOTE: The commented out code below turned out to be unnecessary. The problem
            //       was that the line above was not passing in the initializationOptions to UnityServices.InitializeAsync().
            //       The commented out line below is just another a way of accomplishing what
            //       the commented out line above does (letting us run multiple instances of
            //       a test build of the game on the same PC for multiplayer testing.
